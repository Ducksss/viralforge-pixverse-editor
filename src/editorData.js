  ...
  trendCards: [
    {
      ...
      signal: "+14.2% saves on proof-first hooks",
      shopperIntent: "Trust result before price.",
      translation: "Proof first. Deal second.",
      example: "Bare skin -> serum drop -> window-light glow.",
      hook: "POV: your serum finally shows up on camera.",
      shotPlan: [
        {
          time: "0-3s",
          title: "Bare-skin opener",
          detail: "Face in soft window light; no smoothing.",
        },
        {
          time: "3-7s",
          title: "Texture proof",
          detail: "Macro dropper before any offer.",
        },
        {
          time: "7-15s",
          title: "Glow check",
          detail: "Cheek glow, bottle in hand, Shopee CTA.",
        },
      ],
      overlayCopy: "real glow, one serum drop",
      cta: "Tap the Shopee intro bundle.",
      guardrail: "No poreless or medical claims.",
      checklist: [
        "Real skin",
        "Fast texture cuts",
        "Before/after proof",
    ...
    },
    {
      ...
      fitScore: 88,
      platform: "TikTok",
      signal: "+12.7% completion on sub-30s routines",
      shopperIntent: "Find one step for rushed mornings.",
      translation: "Make the serum the one step that finishes the routine.",
      example: "Alarm -> shelf grab -> serum -> Shopee CTA.",
      hook: "GRWM: five minutes, one serum step.",
      shotPlan: [
        {
          time: "0-2s",
          title: "Rushed cue",
          detail: "Alarm and shelf grab; label readable.",
        },
        {
          time: "2-8s",
          title: "Three-step rhythm",
          detail: "Cleanser, serum, sunscreen in fast cuts.",
        },
        {
          time: "8-15s",
          title: "Doorway finish",
          detail: "Natural-light skin check plus bundle badge.",
        },
      ],
      overlayCopy: "5-minute face, one glow step",
      cta: "Save the routine and grab the set.",
      guardrail: "Keep it casual, not clinical.",
      checklist: [
        "Relatable morning cue",
        "Steps under two seconds",
        "Product-in-hand CTA",
      ],
    },
    {
      ...
      fitScore: 84,
      platform: "Shopee",
      signal: "+9.8% cart lift after proof",
      shopperIntent: "Believe the result, then scan the deal.",
      translation: "Lead with skin proof, then make the bundle obvious.",
      example: "Texture left, bundle price and review count right.",
      hook: "I waited for the bundle before restocking.",
      shotPlan: [
        {
          time: "0-3s",
          title: "Result first",
          detail: "Creator result before price overlay.",
        },
        {
          time: "3-9s",
          title: "Bundle reveal",
          detail: "Bottle, dropper, and bundle tile.",
        },
        {
          time: "9-15s",
          title: "Review proof",
          detail: "Review count plus touch-test close-up.",
        },
      ],
      overlayCopy: "bundle drop + real texture proof",
      cta: "Add the set before the promo ends.",
      guardrail: "One price message only.",
      checklist: [
        "Exact bundle visible",
        "One price message",
        "Proof before discount",
      ],
    },
  ],
  trendTranslation: [
