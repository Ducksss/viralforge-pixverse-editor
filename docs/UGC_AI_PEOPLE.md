...
A library of 31 photoreal UGC creator portraits (13 male, 18 female; mixed ages
and ethnicities, including a Korean K-beauty group) lives in
[`src/assets/ugc/`](../src/assets/ugc/README.md). They are generated by
[`scripts/generate-ugc.mjs`](../scripts/generate-ugc.mjs) and currently exist as
standalone assets, not yet mapped into the `aiPeople` creator profiles.
